        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredHours = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    HalfDayHours = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    OvertimeAfterHours = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    LateGraceMinutes = table.Column<int>(type: "integer", nullable: false),
                    EarlyExitGraceMinutes = table.Column<int>(type: "integer", nullable: false),
                    CheckInWindowMinutes = table.Column<int>(type: "integer", nullable: false),
                    CheckOutWindowMinutes = table.Column<int>(type: "integer", nullable: false),
                    WorkingDays = table.Column<int>(type: "integer", nullable: false),
                    CrossesMidnight = table.Column<bool>(type: "boolean", nullable: false),
                    CalculateOvertime = table.Column<bool>(type: "boolean", nullable: false),
                    HonorHolidayProtection = table.Column<bool>(type: "boolean", nullable: false),
